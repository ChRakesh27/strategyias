...
function IbecUser() {
  ...
  const [filterUser, setFilterUser] = useState({
    ...
    status: { pending: true, accept: true, reject: true },
  });
  ...
  async function fetchUsers() {
    setIsLoading(true);
    const response = await axios.get("/api/admin/ibecUsers/getUsers");
  ...
  async function onChangeStatus(status, userData) {
    setIsLoading(true);
    const response = await axios.post("/api/admin/ibecUsers/updateUsers", {
      id: userData._id,
      data: {
        status,
      },
  ...
  async function onDeleteUser(userData) {
    setIsLoading(true);
    const response = await axios.post("/api/admin/ibecUsers/deleteUsers", {
      id: userData._id,
    });
